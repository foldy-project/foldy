...
impl RunRequest {
    ...
    pub fn make(id: String, backend: String, input: String, config: Map<String, Value>) -> Self {
        RunRequest {
            id,
...
impl Model {
    ...
    pub fn make(chains: Map<String, Value>) -> Self {
        Model { chains }
    }
}
...
impl Structure {
    ...
    pub fn make(models: Map<String, Value>) -> Self {
        Structure { models }
    }
}
